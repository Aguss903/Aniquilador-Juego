...
class Game:
    ...
    def game_over_screen(self):
        ...
        while self.state == 'game_over':
            ...
            draw_text(screen, "Ingresa tu nombre:", buttonFont, pygame.Color('white'), (size[0]//2 - 120, size[1]//2 - 50))
            draw_text(screen, f"Tu puntuación: {self.score}", buttonFont, pygame.Color('white'), (size[0]//2 - 100, size[1]//2 - 100))  # Mostrar la puntuación del jugador
